...
class AboutIteration < Neo::Koan
  ...
  def test_iterating_with_each
    ...
    sum = 0
    array.each do |item|
      # pipes denote a placeholder for one iteration of results
      # (which are taken as an argument to the function between 'do' and 'end')
      sum += item
    end
    assert_equal 6, sum
  end
  ...
  def test_each_can_use_curly_brace_blocks_too
    ...
    # curly braces are a shorthand for 'do' and 'end'
    assert_equal 6, sum
  end
